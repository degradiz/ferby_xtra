 <!--   Core JS Files   -->
<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.bundle.js"></script>

<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.bundle.min.js"></script>

<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.css"></script>

<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.js"></script>

<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.min.css"></script>

<script src="<?php echo base_url(); ?>assets/ajax/libs/Chart.js/2.8.0/Chart.min.js"></script>



  <script src="<?php echo base_url(); ?>theme/assets/js/core/popper.min.js"></script>
  <script src="<?php echo base_url(); ?>theme/assets/js/core/bootstrap-material-design.min.js"></script>
  ...
  <script src="<?php echo base_url(); ?>theme/assets/js/material-dashboard.js?v=2.1.1" type="text/javascript"></script>
