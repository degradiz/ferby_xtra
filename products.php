<?php
  ...
  if(empty($response)){
    ...
    //$add_whatsapp_click = file_get_contents('https://app.almacenesxtra.com/ws/wsMain.php?action=add_whatsapp_click&id='.$id);
    ...
    //       $img = "https://app.almacenesxtra.com/img/".$response[0]->category_img; 
    //     }
    //     $product_img = "https://app.almacenesxtra.com/img/".$response[0]->category_img; 
    //   }else{
    //     $img = "https://app.almacenesxtra.com:8888/wp-content/uploads/2018/02/tr1.png";
    //   }
    // }
